...
class AppLocalizationsPt extends AppLocalizations {
  ...
  String get forceUpdateBodyDefault =>
      'Há uma nova versão do CraftQuest. Atualize para continuar usando o app.';

  @override
  String get forceUpdateAction => 'Atualizar agora';

  @override
  String get appVersionAdminSectionTitle => 'Versão do app';

  @override
  String get appVersionAdminAction => 'Versão mínima exigida';

  @override
  String get appVersionAdminSubtitle => 'Forçar atualização por plataforma';

  @override
  String get appVersionAdminTitle => 'Versão mínima exigida';

  @override
  String get appVersionAdminNotConfigured =>
      'Não configurado (não bloqueia ninguém)';

  @override
  String get appVersionAdminMinVersionLabel => 'Versão mínima';

  @override
  String get appVersionAdminLatestVersionLabel => 'Última versão';

  @override
  String get appVersionAdminUpdateUrlLabel => 'URL de atualização';

  @override
  String get appVersionAdminMessageLabel => 'Mensagem (opcional)';

  @override
  String get appVersionAdminSaved => 'Requisito de versão salvo';
  ...
  @override
  String get offlineDownloadsAction => 'Downloads offline';

  @override
  String get offlineDownloadsViewAction => 'Ver downloads offline';

  @override
  String get offlineDownloadsPlayAction => 'Praticar offline';
  ...
  String get offlineDownloadsEmptyMessage =>
      'Sem downloads offline. Baixe questionarios na tela de detalhes do quiz (plano pago).';
  ...
  String offlineDownloadsItemSummary(
    ...
    return '$questionCount perguntas · $sizeLabel · Midia $mediaReady/$mediaTotal';
  }
  ...
  String verifyEmailPendingMessage(String email) {
    return 'Enviamos um link de ativacao para $email. Verifique a caixa de entrada e o spam.';
  }
  ...
  @override
  String get confirmPasswordChangeInProgress => 'Confirmando sua nova senha…';

  @override
  String get confirmPasswordChangeSuccess => 'Senha atualizada com sucesso.';

  @override
  String get confirmPasswordChangeRetryAction => 'Tentar confirmacao novamente';

  @override
  String get parentalConsentGrantTitle => 'Autorizar conta de menor';

  @override
  String get parentalConsentGrantInProgress => 'Registrando seu consentimento…';

  @override
  String get parentalConsentGrantSuccess =>
      'Consentimento registrado. O menor ja pode entrar com a conta dele.';

  @override
  String get parentalConsentGrantSuccessPendingEmail =>
      'Consentimento registrado. O menor ainda precisa verificar o e-mail antes de entrar.';

  @override
  String get parentalConsentGrantRetryAction => 'Tentar novamente';

  @override
  String get parentalConsentGrantDoneAction => 'Concluido';

  @override
  String get errorInvalidParentalConsentToken =>
      'O link de consentimento e invalido ou expirou. Peca ao menor para reenviar o e-mail ao responsavel.';
  ...
  String get oauthGoogleAndroidSigningHint =>
      ' No Google Cloud Console → Credenciais → cliente OAuth Android (com.craftquestai.craftquestai_app), adicione o SHA-1 da chave de assinatura do Play Console (App signing key), não apenas o do keystore local.';
  ...
  String get upgradeInstitutionHighlight =>
      'Licencas para centros, campi e tutores';
  ...
  @override
  String get prepPlusPreviewFinishCta => 'Finalizar simulação';

  @override
  String get prepPlusPreviewResultTitle => 'Resultado da simulação';

  @override
  String get prepPlusPreviewResultDemoNotice =>
      'Modo demonstração — este resultado não é salvo no seu histórico.';

  @override
  String get prepPlusPreviewTryAgainAction => 'Tentar novamente';

  @override
  String get prepPlusPreviewBackAction => 'Voltar ao detalhe';
  ...
  @override
  String get prepPlusAccessLifetime => 'Acesso definitivo';

  @override
  String get prepPlusAccessLifetimeSubtitle => 'Pratique sem limite de tempo';

  @override
  String get prepPlusAccessOwnedBadge => 'Seu para sempre';

  @override
  String get prepPlusAccessOwnedTitle => 'Você tem acesso definitivo';

  @override
  String get prepPlusAccessOwnedSubtitle =>
      'Pratique quando quiser, sem data de vencimento';

  @override
  String get prepPlusAlreadyOwnedMessage =>
      'Você já tem acesso definitivo a este questionário';
  ...
  @override
  String get prepPlusPracticeOptionsTitle => 'Opções de prática';

  @override
  String get prepPlusPracticeOptionsSummaryDefault => 'Configuração padrão';

  @override
  String get prepPlusPracticeOptionRandom => 'Aleatório';

  @override
  String get prepPlusPracticeOptionTimer => 'Cronômetro';
  ...
  String get prepPlusTrySimulationShort =>
      '3 perguntas de amostra · sem salvar resultados';

  @override
  String get prepPlusProgressAnalyticsShort => 'Análise';

  @override
  String get prepPlusProgressHistoryShort => 'Histórico';
  ...
  String get prepPlusConfirmingAccess =>
      'Confirmando seu acesso ao Preparación+…';
  ...
  String get exportQuizPdfShareFailed =>
      'O PDF foi gerado, mas nao foi possivel compartilhar';
  ...
  String get exportQuizPdfGeneratingHint =>
      'Preparando seu documento. Isso pode levar alguns segundos.';

  @override
  String get exportQuizPdfPlanRequired =>
      'A exportacao para PDF esta disponivel nos planos pagos.';
  ...
  @override
  String get practiceSelectSingleHint => 'Selecione uma opção';

  @override
  String get practiceSelectMultipleHint => 'Selecione todas as que se aplicam';
  ...
  String get practiceReviewHiddenByAssignment =>
      'Seu tutor configurou esta tarefa para não mostrar as respostas corretas. Você só pode ver sua pontuação geral.';
  ...
  String get practiceReviewHiddenTeacherOnly =>
      'Somente seu tutor pode ver as respostas corretas. Você pode consultar sua pontuação geral.';
  ...
  String get excelImportTemplateShareFailed =>
      'O modelo foi baixado, mas nao foi possivel compartilhar';
  ...
  String get importFormatJsonHelp =>
      'Use este formato se tiver um arquivo .json exportado do CraftQuest, um rascunho da IA ou dados de outra ferramenta compativel com CQIF v2.';

  @override
  String get importFormatTxtHelp =>
      'Use este formato se tiver um arquivo de texto simples com a estrutura CraftQuest ([QUIZ], [QUESTION], campos chave=valor). Mais facil de editar manualmente.';

  @override
  String get importFormatUnsureHelp =>
      'Nao tem certeza? Cole o conteudo, escolha o formato mais proximo e toque em «Normalizar com IA» para converter em JSON antes de importar.';

  @override
  String get importContentHintJson => 'Cole aqui o JSON CQIF v2 completo';

  @override
  String get importContentHintTxt =>
      'Cole aqui o arquivo TXT CraftQuest ([QUIZ], [QUESTION]…)';
  ...
  @override
  String get sessionReviewFilterIncorrect => 'Somente erradas';

  @override
  String sessionReviewIncorrectCount(int count) {
    return '$count erradas';
  }

  @override
  String get sessionReviewNoIncorrectQuestions =>
      'Nao ha perguntas erradas nesta tentativa.';

  @override
  String get teacherAssignmentSortDefault => 'Ordem padrao';

  @override
  String get teacherAssignmentSortByBestScore => 'Melhor nota primeiro';
  ...
  String billingCreditsLabel(int generations, int credits) {
    return '~$generations geracoes IA · $credits cr.';
  }
  ...
  String get redeemCodeSubtitle =>
      'Digite o codigo compartilhado pelo tutor ou colega';
  ...
  @override
  String get createShareCodeAction => 'Compartilhar';
  ...
  String get errorDirectInviteNotAllowed =>
      'Convites diretos exigem plano Pro ou Tutor.';
  ...
  String get upgradeProHighlightAiCredits =>
      '~15 geracoes IA por mes (seu plano: ~3)';
  ...
  String upgradePlanHighlightAiCredits(
    ...
    return '~$generations geracoes IA por mes (seu plano: ~$currentGenerations)';
  }
  ...
  @override
  String get paypalReturnTitle => 'Pagamento PayPal';

  @override
  String get paypalReturnProcessing => 'Processando seu pagamento PayPal…';
  ...
  @override
  String get paypalReturnSuccessPrep => 'Acesso Prep+ concedido com sucesso.';

  @override
  String get paypalReturnSuccessCredits =>
      'Créditos de IA adicionados à sua conta.';

  @override
  String get paypalReturnSuccessOrder => 'Pagamento concluído com sucesso.';

  @override
  String get paypalReturnError =>
      'Não foi possível concluir o pagamento PayPal. Tente novamente.';

  @override
  String get paypalReturnCancelled => 'Você cancelou o pagamento no PayPal.';
  ...
  String get purchaseAwaitingApproval =>
      'Aguardando aprovação. Atualizaremos sua conta quando o pagamento for concluído.';

  @override
  String get purchaseTimedOut =>
      'A loja não respondeu a tempo. Se você foi cobrado, reabra o app para sincronizar a compra.';

  @override
  String get purchasePendingStoreTransaction =>
      'Há uma compra pendente na App Store. Estamos sincronizando; tente novamente em alguns segundos.';
  ...
  @override
  String get aiPipelineUploadingTitle => 'Enviando arquivo';

  @override
  String get aiPipelineUploadingSubtitle =>
      'Enviando seu material para o servidor…';

  @override
  String aiPipelineUploadingPercent(int percent) {
    return '$percent% enviado';
  }

  @override
  String get aiPipelineAnalyzingTitle => 'Analisando material';

  @override
  String get aiPipelineAnalyzingSubtitle =>
      'Extraindo texto e preparando o documento para a IA…';

  @override
  String get aiPipelineStepUploadDone => 'Arquivo recebido';

  @override
  String get aiPipelineStepExtracting => 'Extraindo texto';
  ...
  String aiGenerationQuestionCountRecommendedMax(int recommended, int max) {
    return 'Recomendado: $recommended · Maximo: $max';
  }
  ...
  String get errorGroupAccessDeniedGeneric =>
      'Este codigo e apenas para membros da turma do tutor.';
  ...
  String get errorAiCreditPacksNotAvailable =>
      'Pacotes de creditos IA estao disponiveis nos planos Pro e Tutor.';
  ...
  String get aiCreditPacksSubtitle =>
      'Recarregue para continuar gerando com IA (~40 perguntas por geracao). Pacotes nao expiram; a cota mensal do plano reinicia a cada mes.';

  @override
  String aiCreditPacksCurrentBalance(int generations, int credits) {
    return 'Saldo: ~$generations geracoes ($credits cr.)';
  }

  @override
  String aiCreditPacksCreditsLabel(int generations, int credits) {
    return '~$generations geracoes (~$credits cr.)';
  }
  ...
  String get aiCreditsInsufficientFreePlanMessage =>
      'Faca upgrade para Pro ou Tutor para comprar pacotes de creditos IA.';
  ...
  String get guestCodeSubtitle =>
      'Insira o codigo compartilhado pelo seu tutor para praticar sem criar conta.';
  ...
  String get guestRegisterBenefit3 =>
      'Plano Free: 2 questionarios e ~3 geracoes IA, gratis';
  ...
  @override
  String get teacherAssignmentShowAnswersTeacherOnly => 'Somente o tutor';
  ...
  String get studentAssignmentRandomizeLockedShuffled =>
      'Ordem aleatoria definida pelo tutor';

  @override
  String get studentAssignmentRandomizeLockedOrdered =>
      'Ordem do questionario definida pelo tutor';
  ...
  @override
  String get teacherUpgradePopularBadge => 'O mais escolhido por tutores';
  ...
  @override
  String get teacherUpgradeCta => 'Torne-se Tutor';
  ...
  String get teacherUpgradeCancelMessage =>
      'A renovação automática será desativada. Você mantém o plano Tutor até o fim do período pago; depois passa para Free.';
  ...
  String teacherUpgradeCancelSuccessUntil(String date) {
    return 'Renovação automática desativada. Acesso ao plano Tutor até $date.';
  }
  ...
  String get teacherUpgradeExpiryWarning =>
      'Seu plano Tutor vence em menos de 7 dias. Renove para manter o acesso.';

  @override
  String get homeTeacherBannerTitle => 'Você é tutor?';
  ...
  @override
  String get homeTeacherBannerAction => 'Ver plano Tutor';
  ...
  String get studentAssignmentsEmpty =>
      'Você ainda não tem atribuições dos seus tutores.';
  ...
  String get studentAssignmentAttemptScoreOnlyHint =>
      'Somente pontuação — as respostas corretas não estão disponíveis conforme a configuração do tutor.';
  ...
  @override
  String get profileTeacherPlanSectionTitle => 'Plano Tutor';

  @override
  String get profileTeacherPlanManageTitle => 'Gerenciar plano Tutor';
  ...
  @override
  String get paymentProductTypeTeacherSeats => 'Lugares tutor';
  ...
  @override
  String get teacherOnboardingWelcomeTitle => 'Bem-vindo, Tutor!';
  ...
  @override
  String get prepAdminLifetimeOfferSection => 'Acesso definitivo';

  @override
  String get prepAdminTimedOffersSection => 'Acesso por duração';
  ...
  String get prepAdminShareLinkHint =>
      'Use nas redes sociais. Ao abrir, mostra a landing pública com a prévia do item.';

  @override
  String get prepAdminShareLinkUnavailable =>
      'Publique o item para obter o link de compartilhamento.';
  ...
  String get errorPrepQuizCuratedVisibilityNotSupported =>
      'A base de dados não suporta publicar questionários curados. Execute o script PrepPlus_Publish_Quiz_Schema_Patch.sql no Azure SQL.';

  @override
  String get errorPrepQuizIsCuratedColumnMissing =>
      'Falta a coluna IsCurated na tabela de questionários. Execute o script PrepPlus_Publish_Quiz_Schema_Patch.sql no Azure SQL.';

  @override
  String get errorPrepPublishDatabaseConstraint =>
      'Não foi possível publicar por uma restrição da base de dados. Verifique o esquema Prep+ ou contacte o suporte.';
  ...
  String get errorPrepLifetimeOfferDuplicate =>
      'Só pode haver uma oferta de acesso definitivo por item.';
  ...
  @override
  String get notificationsPreferencesTitle => 'Configurações de notificações';

  @override
  String get notificationsPreferencesSubtitle =>
      'Configure como deseja receber cada tipo de aviso.';
  ...
  @override
  String get notificationsPreferencesSectionSharing => 'Partilhados e turmas';

  @override
  String get notificationsPreferencesSectionAssignments => 'Tarefas';

  @override
  String get notificationsPreferencesSectionMembership => 'Assinatura';
  ...
  @override
  String get privacyPolicyLink => 'Politica de privacidade';
  ...
  @override
  String get registerLegalDisclaimerAnd => ' e a ';
  ...
  String get deleteAccountSubtitle =>
      'Seus dados serao excluidos permanentemente. Esta acao nao pode ser desfeita.';

  @override
  String get deleteAccountConfirmHint => 'Digite EXCLUIR para confirmar';
  ...
  @override
  String get deleteAccountSuccess => 'Sua conta foi excluida.';
  ...
  @override
  String get parentalGateSubtitle => 'Para continuar, resolva esta operacao:';
  ...
  @override
  String get ageScreenTitle => 'Quando voce nasceu?';

  @override
  String get ageScreenSubtitle =>
      'Usamos esta informacao para oferecer uma experiencia adequada a sua idade.';

  @override
  String get ageScreenBirthDateLabel => 'Data de nascimento';
  ...
  String get ageScreenMinorNotice =>
      'Como voce e menor de idade, precisara do consentimento de um pai, mae ou responsavel para criar uma conta.';

  @override
  String get guardianEmailLabel => 'E-mail do pai, mae ou responsavel';

  @override
  String get guardianEmailHint => 'responsavel@exemplo.com';

  @override
  String get parentalConsentPendingTitle => 'Aguardando consentimento parental';

  @override
  String parentalConsentPendingMessage(String email) {
    return 'Enviamos um e-mail para $email para que um adulto autorize sua conta.';
  }
  ...
  @override
  String get correctBirthDateSubtitle => 'Se voce indicou a idade errada';

  @override
  String get correctBirthDateSuccess => 'Data de nascimento atualizada';

  @override
  String get correctBirthDateLoginHint => 'Errou a data de nascimento?';
  ...
  String get offlineLocalReviewProvisionalNote =>
      'Revisao baseada no seu download local. O resultado oficial sera confirmado ao sincronizar.';

  @override
  String get offlineProvisionalResultTitle => 'Resultado provisorio';

  @override
  String get offlineSyncPendingNote =>
      'O resultado oficial sera confirmado ao sincronizar com o servidor.';

  @override
  String get offlineSyncNow => 'Sincronizar agora';
