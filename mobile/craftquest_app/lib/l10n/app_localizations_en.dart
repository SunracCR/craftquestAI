...
class AppLocalizationsEn extends AppLocalizations {
  ...
  String get forceUpdateBodyDefault =>
      'A new version of CraftQuest is available. Please update to keep using the app.';

  @override
  String get forceUpdateAction => 'Update now';

  @override
  String get appVersionAdminSectionTitle => 'App version';

  @override
  String get appVersionAdminAction => 'Minimum required version';

  @override
  String get appVersionAdminSubtitle => 'Force update per platform';

  @override
  String get appVersionAdminTitle => 'Minimum required version';

  @override
  String get appVersionAdminNotConfigured =>
      'Not configured (does not block anyone)';

  @override
  String get appVersionAdminMinVersionLabel => 'Minimum version';

  @override
  String get appVersionAdminLatestVersionLabel => 'Latest version';

  @override
  String get appVersionAdminUpdateUrlLabel => 'Update URL';

  @override
  String get appVersionAdminMessageLabel => 'Message (optional)';

  @override
  String get appVersionAdminSaved => 'Version requirement saved';

  @override
  String appVersionAdminFormTitle(String platform) {
    return 'Edit requirement · $platform';
  }
  ...
  @override
  String get parentalConsentGrantTitle => 'Authorize minor account';

  @override
  String get parentalConsentGrantInProgress => 'Recording your consent…';

  @override
  String get parentalConsentGrantSuccess =>
      'Consent recorded. The minor can now sign in with their account.';

  @override
  String get parentalConsentGrantSuccessPendingEmail =>
      'Consent recorded. The minor still needs to verify their email before signing in.';

  @override
  String get parentalConsentGrantRetryAction => 'Retry authorization';

  @override
  String get parentalConsentGrantDoneAction => 'Done';

  @override
  String get errorInvalidParentalConsentToken =>
      'The consent link is invalid or has expired. Ask the minor to resend the guardian email.';
  ...
  String get oauthGoogleAndroidSigningHint =>
      ' In Google Cloud Console → Credentials → Android OAuth client (com.craftquestai.craftquestai_app), add the Play Console App signing key SHA-1, not only your local upload keystore SHA-1.';
  ...
  @override
  String get prepPlusPracticeOptionsTitle => 'Practice options';

  @override
  String get prepPlusPracticeOptionsSummaryDefault => 'Default settings';

  @override
  String get prepPlusPracticeOptionRandom => 'Random';

  @override
  String get prepPlusPracticeOptionTimer => 'Timer';
  ...
  @override
  String get prepPlusCustomPracticeSelectAll => 'All';

  @override
  String get prepPlusCustomPracticeSelectNone => 'None';

  @override
  String get prepPlusCustomPracticeAllChapters => 'All chapters';
  ...
  String prepPlusCustomPracticeSliderLabel(int selected, int total) {
    return '$selected of $total questions';
  }
  ...
  String get prepPlusTrySimulationShort =>
      '3 sample questions · results not saved';

  @override
  String get prepPlusProgressAnalyticsShort => 'Analytics';

  @override
  String get prepPlusProgressHistoryShort => 'History';
  ...
  @override
  String get prepPlusExtendAccessAction => 'Extend access';

  @override
  String get prepPlusExtendAccessCardSubtitle =>
      'Add more days to your current access';
  ...
  @override
  String get prepPlusProgressSectionTitle => 'My progress';
  ...
  @override
  String get sessionReviewFilterAll => 'All';

  @override
  String get sessionReviewFilterIncorrect => 'Failed only';
  ...
  String get sessionReviewNoIncorrectQuestions =>
      'No failed questions in this attempt.';

  @override
  String get teacherAssignmentSortDefault => 'Default order';

  @override
  String get teacherAssignmentSortByBestScore => 'Best score first';
  ...
  String billingCreditsLabel(int generations, int credits) {
    return '~$generations AI generations · $credits cr.';
  }
  ...
  @override
  String get createShareCodeAction => 'Share';
  ...
  String get upgradeProHighlightAiCredits =>
      '~15 AI generations per month (your plan: ~3)';
  ...
  String upgradePlanHighlightAiCredits(
    ...
    return '~$generations AI generations per month (your plan: ~$currentGenerations)';
  }
  ...
  String get upgradeTeacherHighlightAiCredits =>
      '~30 AI generations per month (2× Pro)';
  ...
  @override
  String get aiPipelineUploadingTitle => 'Uploading file';

  @override
  String get aiPipelineUploadingSubtitle =>
      'Sending your material to the server…';
  ...
  @override
  String get aiPipelineAnalyzingTitle => 'Analyzing material';

  @override
  String get aiPipelineAnalyzingSubtitle =>
      'Extracting text and preparing the document for AI…';

  @override
  String get aiPipelineStepUploadDone => 'File received';

  @override
  String get aiPipelineStepExtracting => 'Extracting text';

  @override
  String get aiPipelineStepPreparing => 'Preparing material';
  ...
  String aiGenerationQuestionCountRecommendedMax(int recommended, int max) {
    return 'Recommended: $recommended · Max: $max';
  }
  ...
  String get aiCreditPacksSubtitle =>
      'Top up to keep generating with AI (~40 questions per generation). Packs never expire; your plan quota resets each month.';

  @override
  String aiCreditPacksCurrentBalance(int generations, int credits) {
    return 'Balance: ~$generations generations ($credits cr.)';
  }

  @override
  String aiCreditPacksCreditsLabel(int generations, int credits) {
    return '~$generations generations (~$credits cr.)';
  }
  ...
  String get guestRegisterBenefit3 =>
      'Free plan: 2 quizzes and ~3 AI generations, no cost';
  ...
  @override
  String get prepAdminCoverImageLabel => 'Cover image';
  ...
  String get prepAdminShareLinkHint =>
      'Use on social media. Opening it shows the public landing preview for this item.';

  @override
  String get prepAdminShareLinkUnavailable =>
      'Publish the item to get the share link.';
  ...
  String get deleteAccountSubscriptionNoticeAppStore =>
      'Deleting your CraftQuest account does not cancel your App Store subscription. Cancel it in Settings → Apple ID → Subscriptions.';

  @override
  String get deleteAccountSubscriptionNoticePlayStore =>
      'Deleting your CraftQuest account does not cancel your Google Play subscription. Cancel it in Google Play → Payments & subscriptions.';

  @override
  String get deleteAccountSubscriptionNoticePayPal =>
      'Deleting your CraftQuest account does not cancel your PayPal subscription. Cancel it from your PayPal account.';
  ...
  String get offlineDownloadNeedsUpdate =>
      'This download needs to be updated to include review with justification. Use Update on the quiz detail screen.';

  @override
  String get offlinePackageExpiredMessage =>
      'This offline download has expired. Renew your Prep+ access and download it again to keep practicing.';

  @override
  String get offlineDownloadsExpiredDialogMessage =>
      'This offline download has expired. Remove it from your device or renew your Prep+ access to download it again.';

  @override
  String get offlineViewDetailedReview => 'View detailed review';
  ...
  String get offlineLocalReviewProvisionalNote =>
      'Review based on your local download. The official result will be confirmed when you sync.';

  @override
  String get offlineProvisionalResultTitle => 'Provisional result';

  @override
  String get offlineSyncPendingNote =>
      'The official result will be confirmed when you sync with the server.';
