    ...
    private static LandingLabels ResolveLabels(string? acceptLanguage)
    {
        ...
        if (lang.StartsWith("en", StringComparison.Ordinal))
        {
            return new LandingLabels(
                ...
                EnterCodeSubtitle: "Enter the code shared by your tutor or classmate.",
        ...
        if (lang.StartsWith("pt", StringComparison.Ordinal))
        {
            return new LandingLabels(
                ...
                EnterCodeSubtitle: "Use o codigo compartilhado pelo tutor ou colega.",
        ...
        return new LandingLabels(
            ...
            EnterCodeSubtitle: "Usa el codigo que te compartio tu tutor o companero.",
